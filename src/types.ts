    ...
    switch (kind) {
        ...
        case TypeKind.U64: {
            ...
            if (kind != TypeKind.I16)
                enter(scope, "toInt16", thisP, i8Type)
            if (kind != TypeKind.I32)
                enter(scope, "toInt", thisP, i8Type)
            if (kind != TypeKind.I64)
                enter(scope, "toInt64", thisP, i8Type)
            if (kind != TypeKind.U8)
                enter(scope, "toUInt8", thisP, i8Type)
            if (kind != TypeKind.U16)
                enter(scope, "toUInt16", thisP, i8Type)
            if (kind != TypeKind.U32)
                enter(scope, "toUInt", thisP, i8Type)
            if (kind != TypeKind.U64)
                enter(scope, "toUInt64", thisP, i8Type)
        ...
        case TypeKind.F64: {
            ...
            enter(scope, "reinterpretToUInt64", thisP, u32Type)
            break
        }
        case TypeKind.Boolean:
